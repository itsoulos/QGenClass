...
distdir: FORCE
	...
	$(COPY_FILE) --parents CORE/dataset.h CORE/parameter.h CORE/parameterlist.h CORE/problem.h GE/classprogram.h GE/cprogram.h GE/doublestack.h GE/fparser.hh GE/fpconfig.hh GE/fptypes.hh GE/integeranneal.h GE/population.h GE/program.h GE/rule.h GE/symbol.h $(DISTDIR)/
	$(COPY_FILE) --parents CORE/dataset.cpp CORE/parameter.cpp CORE/parameterlist.cpp CORE/problem.cpp GE/classprogram.cc GE/cprogram.cc GE/doublestack.cc GE/fparser.cc GE/fpoptimizer.cc GE/integeranneal.cpp GE/population.cc GE/program.cc GE/rule.cc GE/symbol.cc main.cpp $(DISTDIR)/
