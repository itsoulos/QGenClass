...
GENPARAMS="--pop_count=500 --pop_size=200 --pop_gens=2000 --pop_srate=0.1 --pop_mrate=0.05 --pop_lrate=0.001 --pop_lmethod=none --pop_fitnessmethod=mean --pop_classpercent=0.5 --pop_averagepercent=0.25 --pop_squaredpercent=0.25 --random_seed=$SEED"
